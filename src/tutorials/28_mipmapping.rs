...
impl VulkanApplication28 {
    pub fn new(event_loop: &winit::event_loop::EventLoop<()>) -> VulkanApplication28 {
        let window =
        ...
        let render_pass = VulkanApplication28::create_render_pass(
            &instance,
            &device,
            physical_device,
            swapchain_stuff.swapchain_format,
        ...
        let (graphics_pipeline, pipeline_layout) = VulkanApplication28::create_graphics_pipeline(
            &device,
            render_pass,
        ...
        let swapchain_framebuffers = VulkanApplication28::create_framebuffers(
            &device,
            render_pass,
        ...
        VulkanApplication28::check_mipmap_support(&instance, physical_device, vk::Format::R8G8B8A8_UNORM);
        let (texture_image, texture_image_memory, mip_levels) = VulkanApplication28::create_texture_image(
            &device,
            command_pool,
            graphics_queue,
            &physical_device_memory_properties,
        ...
        let texture_sampler = VulkanApplication28::create_texture_sampler(&device, mip_levels);
        ...
        let command_buffers = VulkanApplication28::create_command_buffers(
            &device,
            command_pool,
            graphics_pipeline,
    ...
    fn create_texture_image(
        ...
        VulkanApplication28::generate_mipmaps(
            device,
            command_pool,
            submit_queue,
            texture_image,
...
impl Drop for VulkanApplication28 {
    fn drop(&mut self) {
        unsafe {
...
impl VulkanApplicationBase for VulkanApplication28 {
    ...
    fn recreate_swapchain(&mut self) {
        ...
        self.render_pass = VulkanApplication28::create_render_pass(
            &self.instance,
            &self.device,
            self.physical_device,
            self.swapchain_format,
        ...
        self.swapchain_framebuffers = VulkanApplication28::create_framebuffers(
            &self.device,
            self.render_pass,
        ...
        self.command_buffers = VulkanApplication28::create_command_buffers(
            &self.device,
            self.command_pool,
...
fn main() {
    ...
    let vulkan_app = VulkanApplication28::new(&program_proc.event_loop);
